  ...
  return (
    <div className=" mt-12  ">
      <div className=" flex flex-1 justify-between ">
        <div className="  ">
          <div className=" bg-light  w-150  h-150 -left-60 -top-60"></div>
          <div className=" mt-8">
            ...
            <div className="  flex flex-1 mt-2 ">
              <input
                type="text"
                className=" bg-slate-900 font-semibold  font-manrope  h-16 md:h-12  w-9/12 rounded-l-lg px-4"
            ...
            <div className="mt-6 sm:flex  text-white items-center justify-center">
              <img
                src={people}
                alt="people"
